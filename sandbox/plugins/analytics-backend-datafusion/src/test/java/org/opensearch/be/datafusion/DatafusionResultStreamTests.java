...
public class DatafusionResultStreamTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        ...
        long ptr = NativeBridge.createGlobalRuntime(128 * 1024 * 1024, 0L, spillDir.toString(), 64 * 1024 * 1024, false, 0L, Long.MAX_VALUE, "/tmp/opensearch/liquid_cache", "liquid");
    ...
    public void testCloseAfterNativeStreamNextFailure() throws Exception {
        ...
        long ptr2 = NativeBridge.createGlobalRuntime(128 * 1024 * 1024, 0L, spillDir2.toString(), 64 * 1024 * 1024, false, 0L, Long.MAX_VALUE, "/tmp/opensearch/liquid_cache", "liquid");
